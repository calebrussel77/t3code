      ...
      <MenuTrigger
        render={
          <Button
            ...
            className={cn(
              isCodexStyle
                ? "min-w-0 max-w-40 shrink justify-start overflow-hidden whitespace-nowrap px-1.5 text-muted-foreground/70 hover:text-foreground/80 sm:max-w-48 sm:px-2 [&_svg]:mx-0"
