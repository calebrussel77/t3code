...
import { ArchiveIcon, ArrowLeftIcon, GaugeIcon, Settings2Icon } from "lucide-react";
...
export type SettingsSectionPath = "/settings/general" | "/settings/usage" | "/settings/archived";
